...
class Meatloaf
{
    ...
    gui()
    {
        ...
        var meatloafDiv = document.getElementById("meatloaf"); // div of the ui

        meatloafDiv.insertAdjacentHTML("afterbegin", css);

        var fillButton = document.getElementById("meatloafFillAssessmentButton");
...
// Moodle Etco Assessment Text LOokup Auto Filler